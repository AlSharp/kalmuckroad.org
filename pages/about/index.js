...
export default function About() {
  ...
  return (
    <div className={cx('page', 'w-full min-h-[inherit] flex items-center')}>
      <Head>
        <title>Kalmyk-Mongolian Buddhist Center - About Us</title>
        <meta
          name="twitter:card"
        ...
        <meta
          name="description"
          content="Buddhist temple serving the Kalmyk community (Howell, NJ) - About us"
          key="desc"
        />
        <meta property="og:title" content="Kalmyk-Mongolian Buddhist Center About us" />
        <meta
          property="og:description"
          content="Buddhist temple serving the Kalmyk community (Howell, NJ) - About us"
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.kalmuckroad.org/about" />
        <meta
          property="og:image"
