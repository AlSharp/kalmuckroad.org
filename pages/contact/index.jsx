...
export default function About() {
  ...
  return (
    <div className={cx('page', 'w-full min-h-[inherit] flex items-center')}>
      <Head>
        <title>Kalmyk-Mongolian Buddhist Center - Contact</title>
        <meta
          name="twitter:card"
        ...
        <meta
          name="description"
          content="Buddhist temple serving the Kalmyk community (Howell, NJ) - Contact"
          key="desc"
        />
        <meta property="og:title" content="Kalmyk-Mongolian Buddhist Center Contact" />
        <meta
          property="og:description"
          content="Buddhist temple serving the Kalmyk community (Howell, NJ) - Contact"
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.kalmuckroad.org/contact" />
        <meta
          property="og:image"
